...
class SuiviAdmin(AdminPageDescriptionMixin, admin.ModelAdmin):
    page_description = (
        "Points de suivi programmés pour chaque affectation et date correspondante."
    )
...
class JournalAdmin(AdminPageDescriptionMixin, admin.ModelAdmin):
    page_description = (
        "Entrées de journal rédigées par les étudiants pour tracer les activités de stage."
    )
...
class LivrableAdmin(AdminPageDescriptionMixin, admin.ModelAdmin):
    page_description = (
        "Livrables attendus pour chaque affectation avec type, échéance, statut et notation."
    )
    list_display = (
        "affectation",
        "type",
